...
PATH_TO_EXTERNAL_DOWNLOADS = os.path.join(PATH_TO_USER_FILES, "external_downloads-testing")
PATH_TO_TEMP_EXTERNAL_DOWNLOADS = os.path.join(PATH_TO_USER_FILES, "temp_external_downloads-testing")
