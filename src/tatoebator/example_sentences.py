...
class ExampleSentence(CandidateExampleSentence):
    ...
    @classmethod
    def from_candidate(cls, s: CandidateExampleSentence, source_tag: int, trusted: bool, n_known_words: Optional[int] = None):
        return cls(s.sentence, s.translation, s.lexical_words, s.audio_fileid, source_tag, trusted, n_known_words)
